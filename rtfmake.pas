...
Define Class CRtfFile As Custom
  ...
  m_cFileName    = ""   && èìÿ ôàéëà
  m_bOpened      = .F.  && îòêðûò ëè ôàéë ôàéë â íàñòîÿùèé ìîìåíò
  m_bInitialized = .F.  && èíèöèàëèçèðîâàí ëè ôàéë
  m_nFile        = 0    && Äåñêðèïòîð ôàéëà
  m_bParOpen     = .F.
  m_bTextMode    = .F.
  m_bHexCodes    = .F.
  ...
  && Ñâîèñòâà äîëÿ ðàáîòû ñ òàáëèöàìè
  m_nColumnsCount = 100
...
*        Erase &cFileName_
    ...
    THIS.m_bParOpen = .F.
    THIS.m_bTextMode = .F.
    && Èíèöèàëèçèðóåì ìàññèâ øåñòíàäöàòèðè÷íûõ çíà÷åíèé
...
*      .m_oRtfPage = CreateObject("CRtfPage")
  ...
  Procedure PageA5
    With (THIS)
      .PageSetup(.Twips(14.7), .Twips(21), .Twips(1.5), .Twips(1.5), .Twips(2), .Twips(2), .F.)
    EndWith
  EndProc
...
*==============================================================================================
*   Ñîêðàùàåò ñòðîêó, ñîäåðæàùóþ ÷èñëî, äî ïîñëåäíåé çíà÷àùåé öèôðû.
*==============================================================================================
